...
contract ICToken is ERC20Interface, Ownable {
    ...
    function postSet(address recipient, uint amount, uint id, uint256 user_id, string memory title, string memory content, uint256 hits) public onlyOwner {
        transfer(recipient, amount);
        dataStore.setPostData(id, user_id, title, content, hits);
    }
}